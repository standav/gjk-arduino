...
// priklad dotaze (API KEY je jen priklad, je treba mit vlastni):
// const char* resource = "/data/2.5/weather?q=Prague,CZ&appid=bd939aa3d23ff33d3c8f5dd1";
...
// data, ktera chceme ziskat ze stranky
struct clientData {
  char temp[8];
  char humidity[8];
};
